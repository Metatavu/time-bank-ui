...
export class SynchronizeApi extends runtime.BaseAPI {
     ...
     */
    async synchronizeTimeEntriesRaw(requestParameters: SynchronizeTimeEntriesRequest): Promise<runtime.ApiResponse<SyncResponse>> {
     ...
     * Synchronizes time entries from Forecast API.
     */
    async synchronizeTimeEntries(requestParameters: SynchronizeTimeEntriesRequest): Promise<SyncResponse> {
